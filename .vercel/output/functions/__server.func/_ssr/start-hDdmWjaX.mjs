...
//#region node_modules/.nitro/vite/services/ssr/assets/start-hDdmWjaX.js
var errorMiddleware = createMiddleware().server(async ({ next }) => {
	try {
		...
		console.error(error);
		return new Response(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Server Error</title><style>body{background:#050505;color:#fff;font-family:system-ui;display:grid;place-items:center;height:100vh;margin:0}h1{font-size:2rem;letter-spacing:-0.02em}</style></head><body><h1>Server Error</h1><p>Something went wrong. Please try again later.</p></body></html>`, {
			status: 500,
