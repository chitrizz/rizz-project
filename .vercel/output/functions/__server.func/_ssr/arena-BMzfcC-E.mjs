...
import { d as Plus, g as Flame, l as Send, o as Snowflake, r as Trophy, t as X } from "../_libs/lucide-react.mjs";
import { o as motion, s as AnimatePresence } from "../_libs/framer-motion.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/arena-BMzfcC-E.js
...
var SEEDED = [
	{
		...
		category: "Corporate",
		line: "Are you a merger? Because I feel a strong synergy between us.",
	...
	},
	{
		...
		category: "Bollywood",
		line: "Tujh mein Rab dikhta hai — yeh one-liner nahi, sachai hai.",
		createdAt: Date.now() - 1e3 * 60 * 33,
		upvotes: 982,
		downvotes: 88,
		myVote: null
	},
	{
		...
		author: "NeonMonk104",
		category: "Cute",
		line: "I wasn't planning on staying long, but then you happened.",
		createdAt: Date.now() - 1e3 * 60 * 47,
		upvotes: 2103,
		downvotes: 22,
		myVote: null
	},
	{
		id: "s4",
		author: "FlirtyPenguin221",
		category: "Dark Humor",
		line: "Are you a graveyard? Because I dig you.",
		createdAt: Date.now() - 1e3 * 60 * 75,
		upvotes: 612,
		downvotes: 401,
		myVote: null
	},
	{
		id: "s5",
		author: "QuietBandit908",
		category: "Tech",
		line: "Are you JavaScript? You make my heart React.",
		createdAt: Date.now() - 1e3 * 60 * 92,
		upvotes: 1789,
		downvotes: 130,
		myVote: null
	},
	{
		id: "s6",
		author: "MidnightSage615",
		category: "Romantic",
		line: "Your laugh is the melody I want on repeat for the rest of my life.",
		createdAt: Date.now() - 1e3 * 60 * 100,
		upvotes: 2410,
		downvotes: 31,
		myVote: null
	},
	{
		id: "s7",
		author: "FeralCharmer400",
		category: "Gym",
		line: "I came for gains, but I found you instead.",
		createdAt: Date.now() - 1e3 * 60 * 144,
		upvotes: 808,
		downvotes: 92,
		myVote: null
	},
	{
		...
		category: "Anime",
		line: "You're the plot twist I never saw coming but always needed.",
	...
	},
	{
		...
		category: "Desi",
		line: "Tumhe dekh ke laga, biodata wapas refresh karna padega.",
		createdAt: Date.now() - 1e3 * 60 * 222,
		upvotes: 1996,
		downvotes: 47,
		myVote: null
	},
	{
		...
		category: "Finance",
		line: "I'd never short-sell you — you're a long-term hold.",
		createdAt: Date.now() - 1e3 * 60 * 260,
		upvotes: 944,
		downvotes: 28,
		myVote: null
	},
	{
		...
		author: "WiredSiren77",
		category: "Travel",
		line: "Forget compass — my heart only points to you.",
	...
	{
		id: "s12",
		author: "RoyalOperator88",
		category: "Luxury",
		line: "Even Cartier couldn't design anything as stunning as you.",
...
var useArena = create()(persist((set, get) => ({
	posts: SEEDED,
	seed: () => {
		if (get().posts.length === 0) set({ posts: SEEDED });
	},
	addPost: (p) => set((s) => ({ posts: [{
		...p,
	...
	vote: (id, dir) => set((s) => ({ posts: s.posts.map((p) => {
		if (p.id !== id) return p;
